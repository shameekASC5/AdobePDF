...
%%%%%%%%%%%---SETME-----%%%%%%%%%%%%%
\title{Multimodal vs Unimodal: Enhancing Music Genre Classification}
\author{\normalsize{ISCA 2024 Submission
    \textbf{v0.5} -- Confidential Draft -- Do NOT Distribute!!}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
on the ISCA 2023 website. If you use a different
...
By submitting a manuscript to ISCA 2023, the authors guarantee that
...
during the ISCA 2023 review period. Violation of any of these
...
MICRO 2019, ISCA 2020, MICRO 2020, ISCA 2021, HPCA 2022 and ISCA 2022. We thank the organizers of MICRO 2022 for the idea to set up HotCRP topic selections.
